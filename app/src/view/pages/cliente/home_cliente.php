...
?>
  ...
  <div class="w-full mb-15">
    <div class="flex-col flex items-center justify-center text-heading text-6xl font-semibold text-center mt-10 py-2">
      ...
      <div class="text-secondary text-2xl mt-4">
        <p>Última actualización: 03 octubre - Tailwind css.</p>
            ...
            <div class=" flex-wrap flex justify-around mt-12 gap-2 mx-8">
      ...
      <div class="flex-1 md:max-w-1/3 min-w-[400px] md:min-w-0.5 ">
        <div
            class="bg-secondary border-border dark:bg-secondary-dark border dark:border-border-dark rounded-lg shadow-lg p-6 px-10 h-full ">
          <h2 class="text-2xl font-semibold mb-4 text-heading">Unidad 3</h2>
          <p class="mb-4 text-secondary"> Objetos predefinidos en JavaScript </p>
          <div>
            <h3 class="text-xl font-semibold mb-2 text-heading">Ejercicios:</h3>
            <ul class="list-disc list-inside text-secondary space-y-2">
              <li>
                <a class="nav-internal-link" href="/cliente/3/objetos">
