        ...
        >
            ...
            <div>
                ...
                <form id="form_comparacion" class="mt-6">
                    ...
                    <div class="mt-4 flex justify-center">
                        <button type="submit" class="btn-form">Comparar</button>
                    </div>
                </form>
                <div
                ...
                >
                    <h4 class="mb-3 font-semibold">Resultados de Comparación:</h4>
                    <div class="space-y-2 text-sm">
                        <p>
                            <strong>Número 1:</strong>
                            <span id="num1_comp_display"></span>
                        </p>
                        <p>
                            <strong>Número 2:</strong>
                            <span id="num2_comp_display"></span>
                        </p>
                        <p>
                            <strong>Mayor que (>):</strong>
                            <span id="mayor_que_result"></span>
                        </p>
                        <p>
                            <strong>Menor que (<):</strong>
                            <span id="menor_que_result"></span>
                        </p>
                        <p>
                            <strong>Igual que (==):</strong>
                            <span id="igual_que_result"></span>
                        </p>
                    </div>
                </div>
            </div>
            <div>
                ...
                <div class="grid grid-cols-1 gap-x-12 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        >
                            <h4 class="mb-3 font-semibold">Resultados Aritméticos:</h4>
                            <div class="space-y-2 text-sm">
                                <p>
                                    <strong>Suma (+):</strong>
                                    <span id="suma_result"></span>
                                </p>
                                <p>
                                    <strong>Resta (-):</strong>
                                    <span id="resta_result"></span>
                                </p>
                                <p>
                                    <strong>Multiplicación (×):</strong>
                                    <span id="multiplicacion_result"></span>
                                </p>
                                <p>
                                    <strong>División (÷):</strong>
                                    <span id="division_result"></span>
                                </p>
                                <p>
                                    <strong>Módulo (%):</strong>
                                    <span id="modulo_result"></span>
                                </p>
                                <p>
                                    <strong>Potencia (**):</strong>
                                    <span id="potencia_result"></span>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                ...
                <form id="form_logicos" class="mt-6">
                    ...
                    <div class="mt-4 flex justify-center">
                        <button type="submit" class="btn-form">Validar</button>
                    </div>
                </form>
                <div
                    class="mt-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-700"
                ...
                >
                    <p>
                        Edad válida (18-65):
                        <span id="edad_valida_result"></span>
                    </p>
                    <p>
                        Contraseña válida (≥8 chars):
                        <span id="password_valida_result"></span>
                    </p>
                </div>
            </div>
            ...
            <div>
                ...
                <form id="form_bitwise" class="mt-6">
                    ...
                    <div class="mt-4 flex justify-center">
                        <button type="submit" class="btn-form">Calcular Operaciones Bit a Bit</button>
                    </div>
                </form>
                <div
                    class="mt-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-700"
                ...
                >
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            <p>
                                Número 1:
                                <span id="num1_display"></span>
                                (
                                <span id="num1_binary"></span>
                                )
                            </p>
                            <p>
                                Número 2:
                                <span id="num2_display"></span>
                                (
                                <span id="num2_binary"></span>
                                )
                            </p>
                        </div>
                        <div>
                            <p>
                                AND (&):
                                <span id="and_result"></span>
                                (
                                <span id="and_binary"></span>
                                ) - 1 solo si ambos bits son 1
                            </p>
                            <p>
                                OR (|):
                                <span id="or_result"></span>
                                (
                                <span id="or_binary"></span>
                                ) - 1 si al menos un bit es 1
                            </p>
                            <p>
                                XOR (^):
                                <span id="xor_result"></span>
                                (
                                <span id="xor_binary"></span>
                                ) - 1 si los bits son diferentes
                            </p>
                            <p>
                                NOT (~)
                                <span id="not_num"></span>
                                ):
                                <span id="not_result"></span>
                                (
                                <span id="not_binary"></span>
            ...
            <div>
                ...
                <form id="form_objetos" class="mt-6">
                    ...
                    <div class="mt-4 flex justify-center">
                        <button type="submit" class="btn-form">Crear Objeto y Eliminar Propiedad</button>
                    </div>
                </form>
                <div
                    class="mt-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-700"
                ...
                >
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            <h4 class="mb-2 font-semibold">Objeto ANTES de delete:</h4>
                            <pre class="rounded bg-white p-2 text-sm dark:bg-gray-600" id="objeto_antes"></pre>
                        </div>
                        <div>
                            <h4 class="mb-2 font-semibold">Objeto DESPUÉS de delete:</h4>
                            <pre class="rounded bg-white p-2 text-sm dark:bg-gray-600" id="objeto_despues"></pre>
                        </div>
                    </div>
                    <p class="mt-3">
                        Operación: delete persona['
                        <span id="propiedad_eliminada"></span>
                        ']
                    </p>
                </div>
            </div>
            ...
            <div>
                ...
                <form id="form_precedencia" class="mt-6">
                    ...
                    <div class="mt-4 flex justify-center">
                        <button type="submit" class="btn-form">Calcular Precedencia</button>
                    </div>
                </form>
                <div
                    class="mt-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-700"
                ...
                >
                    <h4 class="mb-3 font-semibold">Operaciones Aritméticas:</h4>
                    <div class="space-y-2 text-sm">
                        <p>
                            Sin paréntesis:<
                            <span id="formula_sin_parentesis"></span>
                            =
                            <span id="resultado_sin_parentesis"></span>
                        </p>
                        <p>
                            Con paréntesis:<
                            <span id="formula_parentesis1"></span>
                            =
                            <span id="resultado_parentesis1"></span>
                        </p>
                        <p>
                            Con paréntesis:<
                            <span id="formula_parentesis2"></span>
                            =
                            <span id="resultado_parentesis2"></span>
                        </p>
                        <p>
                            Con paréntesis:<
                            <span id="formula_parentesis3"></span>
                            =
                            <span id="resultado_parentesis3"></span>
                        </p>
                    </div>
                    <h4 class="mt-4 mb-3 font-semibold">Operaciones Booleanas:</h4>
                    <div class="space-y-2 text-sm">
                        <p>
                            Sin paréntesis:<
                            <span id="formula_bool_sin"></span>
                            =
                            <span id="resultado_bool_sin"></span>
                        </p>
                        <p>
                            Con paréntesis:<
                            <span id="formula_bool_con"></span>
                            =
                            <span id="resultado_bool_con"></span>
                        </p>
                    </div>
                </div>
            </div>
