        ...
        <div class="mx-auto flex max-w-screen-xl items-center justify-between p-4">
          ...
          <div class="hidden items-center space-x-10 md:flex" id="navbar-default">
            ...
            <ul class="flex space-x-4">
              <li>
                <a href="/cliente" class="nav-link <?= isCurrentUrl('/cliente') ? 'active' : '' ?>">Cliente</a>
              </li>
              <li>
                <a href="/servidor" class="nav-link <?= isCurrentUrl('/servidor') ? 'active' : '' ?>">Servidor</a>
              </li>
              <li>
                <a href="/diseno" class="nav-link <?= isCurrentUrl('/diseno') ? 'active' : '' ?>">Diseño</a>
              </li>
              <li>
                <a href="/anexos" class="nav-link <?= isCurrentUrl('/anexos') ? 'active' : '' ?>">Anexos</a>
              </li>
            </ul>
            ...
            <div class="flex items-center space-x-4">
              ...
              <!-- Usuario autenticado -->
              <div class="flex items-center space-x-4">
                <a href="/profile" class="nav-link <?= isCurrentUrl('/profile') ? 'active' : '' ?>">Perfil</a>
                <a
                  href="/logout"
                  class="rounded-lg border-2 border-rose-500 bg-rose-500 px-4 py-2 text-sm font-semibold text-white transition-colors hover:border-rose-600 hover:bg-rose-600 focus:ring-2 focus:ring-rose-400 focus:ring-offset-2 focus:outline-none dark:border-rose-600 dark:bg-rose-600 dark:hover:border-rose-700 dark:hover:bg-rose-700"
                >
                  Cerrar Sesión
                </a>
              </div>
              ...
              <a href="/login" class="nav-link <?= isCurrentUrl('/login') ? 'active' : '' ?>">Iniciar Sesión</a>
              <a
                href="/register"
